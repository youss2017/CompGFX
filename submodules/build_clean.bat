...
msbuild rebuild Assimp.sln /p:Configuration=Debug
msbuild rebuild Assimp.sln /p:Configuration=Release
...
msbuild rebuild GLFW.sln /p:Configuration=Debug
msbuild rebuild GLFW.sln /p:Configuration=Release
