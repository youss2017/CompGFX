...
std::string GRAPHICS_API Utils::CreateDialogFilter(std::vector<std::pair<std::string, std::string>> items) {
	std::string filter = "";
...
std::string GRAPHICS_API Utils::SaveAsDialog(const std::string& filter, int& OutChoosenFilterIndex) {
	char szFile[256]{0};
	OPENFILENAMEA open{};
