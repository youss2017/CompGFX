...
namespace VkAlloc
{
	CONTEXT CreateContext(VkInstance instance, VkDevice device, VkPhysicalDevice physicalDevice, uint32_t HeapBlockAllocationSize)
	{
		...
		createInfo.flags = VMA_ALLOCATOR_CREATE_EXT_MEMORY_PRIORITY_BIT | VMA_ALLOCATOR_CREATE_KHR_BIND_MEMORY2_BIT | VMA_ALLOCATOR_CREATE_BUFFER_DEVICE_ADDRESS_BIT;
