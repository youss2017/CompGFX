...
enum BindingFlagBits : unsigned int {
	BINDING_FLAG_CPU_VISIBLE			= 0x0001,
	BINDING_FLAG_CREATE_BUFFERS_POINTER	= 0x0010,
	BINDING_FLAG_REQUIRE_COHERENT		= 0x0100,
	BINDING_FLAG_BUFFER_USAGE_INDIRECT  = 0x1000,
};
